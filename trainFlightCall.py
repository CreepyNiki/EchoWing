...
birdDir = f'Files/{birdName}'  # Enthält Unterordner je Rufart
MODEL_PATH = 'models/audio-model.h5'  # Pfad zum geladenen BirdNET SavedModel
OUTPUT_MODEL_PATH = f'models/birdnet_finetuned_rufarten_{birdName}.keras'
...
with open(f'{birdName}_val_files.txt', "w") as f:
    for path in X_val:
        f.write(path + "\n")
